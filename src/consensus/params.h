...
struct Params {
    ...
    // validation by-pass
    int64_t nPassionBadBlockTime;
    unsigned int nPassionBadBlockBits;
    ...
    bool IsTimeProtocolV2(const int nHeight) const { return NetworkUpgradeActive(nHeight, UPGRADE_POS); }
