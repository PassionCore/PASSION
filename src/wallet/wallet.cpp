        ...
        const bool fIncludeLocked) const
{
    ...
    // Skip locked utxo
    if (!fIncludeLocked && IsLockedCoin(wtxid, outIndex) && nCoinType != ONLY_MN_OUTPUTS) return res;
        ...
        std::vector<CStakeableOutput>* availableCoins)
{
    ...
    for (auto it = availableCoins->begin(); it != availableCoins->end();) {
        ...
        //MULTI TIER STAKING
        ////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        LogPrintf("%s : Regular staking processed, add Multi-Tier-Staking.\n", __func__);
        CAmount blockvalue = GetBlockValue(pindexPrev->nHeight+1);
        bool ret = CMultiTier::getInstance()->FillTransactionMultiTier(txNew, blockvalue, pindexPrev);
        LogPrintf("%s : Multi-Tier-Staking outputs processed.\n", __func__);
        ////////////////////////////////////////////////////////////////////////////////////////////////////////////////
