...
void AskPassphraseDialog::accept()
{
    ...
    case Mode::Encrypt: {
        ...
        if (ret) {
            ...
            PassionGUI* window = static_cast<PassionGUI*>(parentWidget());
...
{
    PassionGUI* gui = static_cast<PassionGUI*>(parentWidget());
...
{
    hide();
    static_cast<PassionGUI*>(parentWidget())->showHide(true);
    openStandardDialog(
            tr("Wallet encrypted"),
            "<qt>" +
            tr("Passion will close now to finish the encryption process. "
               "Remember that encrypting your wallet cannot fully protect "
               "your PASSIONs from being stolen by malware infecting your computer.") +
            "<br><br><b>" +
