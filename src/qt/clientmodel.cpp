...
static void ChatMessageReceived(ClientModel *clientmodel, CChatMessage message)
{
    std::cout << "Clientmodel -> New Message received -> "<< message.strDestination << std::endl;
    Q_EMIT clientmodel->newChatMessage(QString::fromStdString(message.strMessageFrom), QString::fromStdString(message.GetDecryptedMessage()));
}
...
void ClientModel::subscribeToCoreSignals()
{
    ...
    m_handler_notify_chat_message = interfaces::MakeHandler(uiInterface.NotifyChatMessage.connect(std::bind(ChatMessageReceived, this, std::placeholders::_1)));
}
...
void ClientModel::unsubscribeFromCoreSignals()
{
    ...
    m_handler_notify_chat_message->disconnect();
}
