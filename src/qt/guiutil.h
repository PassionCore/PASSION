...
/** Utility functions used by the Passion Qt UI.
 */
namespace GUIUtil
{
...
// Render Passion addresses in monospace font
...
// Parse "passion:" URI into recipient object, return true on successful parsing
