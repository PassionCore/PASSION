...
bool Intro::pickDataDirectory()
{
    ...
    bool exists = fs::exists(GUIUtil::qstringToBoostPath(dataDir));
    bool defau = gArgs.GetBoolArg("-choosedatadir", DEFAULT_CHOOSE_DATADIR);
    if ( !exists || defau ) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Passion Core"),
     ...
     * override -datadir in the passion.conf file in the default data directory
     * (to be consistent with passiond behavior)
     */
