...
// Copyright (c) 2016-2020 The Passion developers
...
QVariant TransactionTableModel::txAddressDecoration(const TransactionRecord* wtx) const
{
    ...
    case TransactionRecord::Generated:
    case TransactionRecord::StakeMint:
    case TransactionRecord::StakeRewardTier1:
    case TransactionRecord::StakeRewardTier2:
    case TransactionRecord::StakeRewardTier3:
    case TransactionRecord::StakeRewardTier4:
...
QVariant TransactionTableModel::data(const QModelIndex& index, int role) const
{
    ...
    case Qt::ForegroundRole:
        ...
        if (rec->type == TransactionRecord::Generated || rec->type == TransactionRecord::StakeMint ||
                rec->type == TransactionRecord::StakeRewardTier1 ||
                rec->type == TransactionRecord::StakeRewardTier2 ||
                rec->type == TransactionRecord::StakeRewardTier3 ||
                rec->type == TransactionRecord::StakeRewardTier4)
        {
