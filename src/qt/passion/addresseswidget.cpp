...
#include "qt/passion/forms/ui_addresseswidget.h"
#include "qt/passion/addresslabelrow.h"
#include "qt/passion/addnewaddressdialog.h"
#include "qt/passion/tooltipmenu.h"
...
AddressesWidget::AddressesWidget(PassionGUI* parent) :
    PWidget(parent),
