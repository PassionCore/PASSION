...
#include "qt/passion/subscription/ui_subscriptioninfodialog.h"
...
SubscriptionInfoDialog::SubscriptionInfoDialog(QWidget *parent) :
    FocusedDialog(parent),
    ui(new Ui::SubscriptionInfoDialog)
{
    ui->setupUi(this);
    ...
    connect(ui->btnEsc, &QPushButton::clicked, this, &SubscriptionInfoDialog::close);
...
void SubscriptionInfoDialog::setData(QString pubKey, QString name, QString address, QString txId, QString outputIndex, QString status)
{
    this->pubKey = pubKey;
    this->txId = txId;
...
void SubscriptionInfoDialog::copyInform(QString& copyStr, QString message)
{
...
void SubscriptionInfoDialog::reject()
{
