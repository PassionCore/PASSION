...
#ifndef Passion_CORE_NEW_GUI_PassionGUI_H
#define Passion_CORE_NEW_GUI_PassionGUI_H
...
#include "qt/passion/navmenuwidget.h"
#include "qt/passion/topbar.h"
#include "qt/passion/dashboardwidget.h"
#include "qt/passion/send.h"
#include "qt/passion/receivewidget.h"
#include "qt/passion/addresseswidget.h"
...
/**
  Passion GUI main class. This class represents the main window of the Passion UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class PassionGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit PassionGUI(const NetworkStyle* networkStyle, QWidget* parent = 0);
    ~PassionGUI();
...
#endif //Passion_CORE_NEW_GUI_PassionGUI_H
