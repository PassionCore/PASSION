...
#include "qt/passion/forms/ui_navmenuwidget.h"
...
NavMenuWidget::NavMenuWidget(PassionGUI *mainWindow, QWidget *parent) :
    ...
    ui(new Ui::NavMenuWidget)
{
    ...
    btns = {ui->btnDashboard, ui->btnSend, ui->btnReceive, ui->btnAddress, ui->btnColdStaking, ui->btnSettings, ui->btnSubscription, ui->btnColdStaking};
