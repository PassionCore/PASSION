...
#include "qt/passion/settings/settingsbittoolwidget.h"
#include "qt/passion/settings/forms/ui_settingsbittoolwidget.h"
...
SettingsBitToolWidget::SettingsBitToolWidget(PassionGUI* _window, QWidget *parent) :
