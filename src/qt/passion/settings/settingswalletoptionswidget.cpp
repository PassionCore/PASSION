...
SettingsWalletOptionsWidget::SettingsWalletOptionsWidget(PassionGUI* _window, QWidget *parent) :
...
void SettingsWalletOptionsWidget::setMapper(QDataWidgetMapper *mapper){
    ...
    mapper->addMapping(ui->checkBoxAutoLockStakeTierUTXO, OptionsModel::AutoLockStakeTierUTXO);
