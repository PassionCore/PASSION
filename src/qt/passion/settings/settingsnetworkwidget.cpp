...
#include "qt/passion/settings/settingsnetworkwidget.h"
#include "qt/passion/settings/forms/ui_settingsnetworkwidget.h"
#include "optionsmodel.h"
#include "qt/passion/qtutils.h"

SettingsNetworkWidget::SettingsNetworkWidget(PassionGUI* _window, QWidget *parent) :
