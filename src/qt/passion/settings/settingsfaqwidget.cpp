...
#include "qt/passion/settings/forms/ui_settingsfaqwidget.h"
#include <QScrollBar>
#include <QMetaObject>
#include "qt/passion/qtutils.h"

SettingsFaqWidget::SettingsFaqWidget(PassionGUI *parent) :
    QDialog(parent),
    ui(new Ui::SettingsFaqWidget)
{
    ...
    setCssProperty({
           ...
           ui->labelNumber_UnspendablePASSION,
    ...
    setCssProperty({
              ...
              ui->labelSubtitle_UnspendablePASSION,
    ...
    setCssProperty({
              ...
              ui->labelContent_UnspendablePASSION,
    ...
    setCssProperty({
              ui->pushButton_Intro,
              ui->pushButton_UnspendablePASSION,
              ui->pushButton_Stake,
    ...
    connect(ui->pushButton_UnspendablePASSION, &QPushButton::clicked, [this](){onFaqClicked(ui->widget_UnspendablePASSION);});
    ...
    if (parent)
        connect(parent, &PassionGUI::windowResizeEvent, this, &SettingsFaqWidget::windowResizeEvent);
}
