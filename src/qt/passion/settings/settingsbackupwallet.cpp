...
#include "qt/passion/settings/settingsbackupwallet.h"

#include "qt/passion/settings/forms/ui_settingsbackupwallet.h"
...
SettingsBackupWallet::SettingsBackupWallet(PassionGUI* _window, QWidget *parent) :
