...
#include "qt/passion/settings/forms/ui_settingswalletrepairwidget.h"
#include "qt/passion/qtutils.h"

SettingsWalletRepairWidget::SettingsWalletRepairWidget(PassionGUI* _window, QWidget *parent) :
...
void SettingsWalletRepairWidget::buildParameterlist(QString arg)
{
    ...
    // Send command-line arguments to PassionGUI::handleRestart()
