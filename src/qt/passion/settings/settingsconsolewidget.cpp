...
#include "qt/passion/settings/settingsconsolewidget.h"
#include "qt/passion/settings/forms/ui_settingsconsolewidget.h"
#include "qt/passion/settings/moc_settingsconsolewidget.cpp"
...
SettingsConsoleWidget::SettingsConsoleWidget(PassionGUI* _window, QWidget *parent) :
...
void SettingsConsoleWidget::clear(bool clearHistory)
{
    ...
    messageInternal(RPCExecutor::CMD_REPLY, (tr("Welcome to the Passion RPC console.") + "<br>" +
