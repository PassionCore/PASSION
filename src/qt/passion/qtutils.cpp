...
void closeDialog(QDialog* widget, PassionGUI* gui)
{
    widget->setWindowFlags(Qt::CustomizeWindowHint);
    widget->setAttribute(Qt::WA_TranslucentBackground, true);
    QPropertyAnimation* animation = new QPropertyAnimation(widget, "pos");
...
bool openDialogWithOpaqueBackgroundY(QDialog* widget, PassionGUI* gui, double posX, int posY)
{
    widget->setWindowFlags(Qt::CustomizeWindowHint);
    widget->setAttribute(Qt::WA_TranslucentBackground, true);
    QPropertyAnimation* animation = new QPropertyAnimation(widget, "pos");
...
bool openDialogWithOpaqueBackground(QDialog* widget, PassionGUI* gui, double posX)
{
    return openDialogWithOpaqueBackgroundY(widget, gui, posX, 5);
}

bool openDialogWithOpaqueBackgroundFullScreen(QDialog* widget, PassionGUI* gui)
{
    widget->setWindowFlags(Qt::CustomizeWindowHint);
    widget->setAttribute(Qt::WA_TranslucentBackground, true);
...
void setSortTxTypeFilter(QComboBox* filter, SortEdit* lineEditType)
{
    ...
    filter->addItem(QObject::tr("Stake Tier 1"), TransactionFilterProxy::TYPE(TransactionRecord::StakeRewardTier1));
    filter->addItem(QObject::tr("Stake Tier 2"), TransactionFilterProxy::TYPE(TransactionRecord::StakeRewardTier2));
    filter->addItem(QObject::tr("Stake Tier 3"), TransactionFilterProxy::TYPE(TransactionRecord::StakeRewardTier3));
    filter->addItem(QObject::tr("Stake Tier 4"), TransactionFilterProxy::TYPE(TransactionRecord::StakeRewardTier4));
