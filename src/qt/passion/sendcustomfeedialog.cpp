...
#include "qt/passion/sendcustomfeedialog.h"
#include "qt/passion/forms/ui_sendcustomfeedialog.h"
...
SendCustomFeeDialog::SendCustomFeeDialog(PassionGUI* parent, WalletModel* model) :
    ...
    walletModel(model)
{
    ...
    if (parent)
        connect(parent, &PassionGUI::themeChanged, this, &SendCustomFeeDialog::onChangeTheme);
