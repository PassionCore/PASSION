...
#include "qt/passion/forms/ui_coldstakingwidget.h"
#include "qt/passion/qtutils.h"
#include "amount.h"
#include "guiutil.h"
#include "qt/passion/requestdialog.h"
...
ColdStakingWidget::ColdStakingWidget(PassionGUI* parent) :
    PWidget(parent),
