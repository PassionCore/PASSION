/* src/config/passion-config.h.  Generated from passion-config.h.in by configure.  */
/* src/config/passion-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef PASSION_CONFIG_H

#define PASSION_CONFIG_H
...
#define PACKAGE_BUGREPORT "https://github.com/passion-project/passion/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Passion Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Passion Core 1.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "passion"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://passion.org/"
