#!/usr/bin/env python3
# Copyright (c) 2020 The Passion Core developers
...
class SaplingMempoolTest(PassionTestFramework):
    ...
    def run_test(self):
        ...
        # miner sends a 10 PASSION note to Alice
        ...
        # miner sends another 10 PASSION note to Alice
