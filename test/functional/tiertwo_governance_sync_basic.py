...
from test_framework.test_framework import PassionTier2TestFramework
...
class MasternodeGovernanceBasicTest(PassionTier2TestFramework):
    ...
    def run_test(self):
        ...
        firstProposalLink = "https://forum.passion.org/t/test-proposal"
