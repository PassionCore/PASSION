...
"""Verify that starting passion with -h works as expected."""
import subprocess

from test_framework.test_framework import PassionTestFramework
from test_framework.util import assert_equal

class HelpTest(PassionTestFramework):
    ...
    def run_test(self):
        self.log.info("Start passion with -? for help text")
        ...
        self.log.info("Start passion with -version for version information")
