...
class ListReceivedTest (PassionTestFramework):
    ...
    def run_test(self):
        ...
        self.nodes[0].sendtoaddress(taddr, 6.0) # node_1 in taddr with 6 PASSION.
        ...
        # Send 1 PASSION to shield addr1
        txid = self.nodes[1].shieldsendmany(taddr, [ # node_1 with 6 PASSION sending them all (fee is 0.1 PASSION)
        ...
        # Confirm transaction (2 PASSION from taddr to shield_addr1)
        ...
        txid = self.nodes[1].shieldsendmany(shield_addr1, # shield_addr1 has 2 PASSION, send 0.6 PASSION + 0.05 PASSION fee
