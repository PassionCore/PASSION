...
RESOURCES += src/qt/passion.qrc src/qt/passion_locale.qrc

TRANSLATIONS += src/qt/locale/passion_de.ts \
                src/qt/locale/passion_en.ts 
