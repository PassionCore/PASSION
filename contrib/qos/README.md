...
This means one can have an always-on passiond instance running, and another local passiond/passion-qt instance which connects to this node and receives blocks from it.
